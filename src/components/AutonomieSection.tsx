...
import styles from "./AutonomieSection.module.scss";
...
interface AutonomieSectionProps {
  className?: string;
  id?: string;
}
...
export const AutonomieSection: React.FC<AutonomieSectionProps> = ({
  className,
  id,
}) => {
...
export default AutonomieSection;
